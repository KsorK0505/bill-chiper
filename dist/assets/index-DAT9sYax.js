const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "assets/index-304J_KGd.js",
      "assets/index-RmsPT7oH.js",
      "assets/index-Cu4PQVaO.css",
    ]),
) => i.map((i) => d[i]);
import { _ as fe } from "./index-RmsPT7oH.js";
const pe = Symbol(),
    ...
    c = (o, h, I = n) => {
      ...
      return (
        ...
        Reflect.ownKeys(o).forEach((D) => {
          if (Object.getOwnPropertyDescriptor(v, D)) return;
          const W = Reflect.get(o, D),
            A = { value: W, enumerable: !0, configurable: !0 };
          if (x.has(W)) ee(W, !1);
          else if (W instanceof Promise) delete A.value, (A.get = () => I(W));
          else if (L.has(W)) {
            const [b, z] = L.get(W);
            A.value = c(b, z(), I);
          }
          Object.defineProperty(v, D, A);
        }),
    ...
    E = (o) => {
        ...
        R = t(H, {
          ...
          set(i, a, r, g) {
            const U = Reflect.has(i, a),
              k = Reflect.get(i, a, g);
            if (U && (e(k, r) || (d.has(r) && e(k, d.get(r))))) return !0;
            X(a), q(r) && (r = ge(r) || r);
            let V = r;
            if (r instanceof Promise)
              r.then((C) => {
                (r.status = "fulfilled"), (r.value = C), v(["resolve", [a], C]);
              }).catch((C) => {
                (r.status = "rejected"), (r.reason = C), v(["reject", [a], C]);
              });
            else {
              !L.has(r) && s(r) && (V = E(r));
      ...
      return (
        ...
        Reflect.ownKeys(o).forEach((i) => {
          ...
          "value" in a && ((R[i] = o[i]), delete a.value, delete a.writable),
            Object.defineProperty(H, i, a);
        }),
        R
      );
    },
  ) => [E, L, x, e, t, s, n, l, c, d, f],
  [ye] = he();
function P(e = {}) {
  return ye(e);
}
...
var Ie = Object.defineProperty,
  ...
  se = (e, t, s) =>
    t in e
      ? Ie(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s })
      : (e[t] = s),
  We = (e, t) => {
    for (var s in t || (t = {})) Oe.call(t, s) && se(e, s, t[s]);
    if (te) for (var s of te(t)) _e.call(t, s) && se(e, s, t[s]);
    return e;
  };
...
async function K(e, t) {
  const s = We({ sdkType: G, sdkVersion: Q }, t),
    n = new URL(e, Y);
  return (
    n.searchParams.append("projectId", $.state.projectId),
...
const M = {
  ...
  getWalletImageUrl(e) {
    return `${Y}/w3m/v1/getWalletImage/${e}?projectId=${$.state.projectId}&sdkType=${G}&sdkVersion=${Q}`;
  },
  getAssetImageUrl(e) {
    return `${Y}/w3m/v1/getAssetImage/${e}?projectId=${$.state.projectId}&sdkType=${G}&sdkVersion=${Q}`;
  },
};
var Ee = Object.defineProperty,
  ...
  oe = (e, t, s) =>
    t in e
      ...
      : (e[t] = s),
  Pe = (e, t) => {
    for (var s in t || (t = {})) Ce.call(t, s) && oe(e, s, t[s]);
    if (ne) for (var s of ne(t)) Le.call(t, s) && oe(e, s, t[s]);
    return e;
  };
const re = m.isMobile(),
  _ = P({
  ...
  ke = {
    ...
    async getRecomendedWallets() {
      const { explorerRecommendedWalletIds: e, explorerExcludedWalletIds: t } =
        $.state;
      if (e === "NONE" || (t === "ALL" && !e)) return _.recomendedWallets;
      if (m.isArray(e)) {
        ...
        c.sort((d, f) => {
          ...
          (_.recomendedWallets = c);
      } else {
        const { chains: s, isAuth: n } = w.state,
          ...
          { listings: f } = re
            ? await M.getMobileListings(d)
            : await M.getDesktopListings(d);
        _.recomendedWallets = Object.values(f);
      }
    ...
    async getWallets(e) {
      const t = Pe({}, e),
        { explorerRecommendedWalletIds: s, explorerExcludedWalletIds: n } =
          $.state,
        { recomendedWallets: l } = _;
      if (n === "ALL") return _.wallets;
      l.length
      ...
      const { page: c, search: d } = e,
        { listings: f, total: E } = re
          ? await M.getMobileListings(t)
          : await M.getDesktopListings(t),
        o = Object.values(f),
        h = d ? "search" : "wallets";
      return (
        (_[h] = { listings: [..._[h].listings, ...o], total: E, page: c ?? 1 }),
        { listings: o, total: E }
      );
    },
    getWalletImageUrl(e) {
...
var Ae = Object.defineProperty,
  ...
  ie = (e, t, s) =>
    t in e
      ? Ae(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s })
      : (e[t] = s),
  je = (e, t) => {
    for (var s in t || (t = {})) Me.call(t, s) && ie(e, s, t[s]);
    if (ae) for (var s of ae(t)) Se.call(t, s) && ie(e, s, t[s]);
    return e;
  };
function De() {
  return (
...
const N = P({ themeMode: De() ? "dark" : "light" }),
  le = {
    state: N,
    subscribe(e) {
      return j(N, () => e(N));
  ...
  S = P({ open: !1, message: "", variant: "success" }),
  Ne = {
    state: S,
    subscribe(e) {
      return j(S, () => e(S));
...
class Ue {
  ...
  async initUi() {
    if (typeof window < "u") {
      await fe(() => import("./index-304J_KGd.js"), __vite__mapDeps([0, 1, 2]));
