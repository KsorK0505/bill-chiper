import { l as Qe, m as Ze, n as Xe, E as et } from "./index-RmsPT7oH.js";
import { r as tt } from "./sha3-CIz8bATs.js";
import { D as Z, g as w, h as ce, y as nt } from "./hooks.module-dNE3f9LZ.js";
class A {
  constructor(e, n) {
  ...
  static clearAll() {
    new A("CBWSDK").clear(), new A("walletlink").clear();
  }
}
const y = {
    rpc: {
  ...
  _e = "Unspecified error message.",
  st = "Unspecified server error.";
function se(t, e = _e) {
  if (t && Number.isInteger(t)) {
    const n = t.toString();
    if (ee(X, n)) return X[n].message;
    if (xe(t)) return st;
  }
  return e;
}
  ...
  if (
    ...
    (n.code = s.code),
      s.message && typeof s.message == "string"
        ? ((n.message = s.message), ee(s, "data") && (n.data = s.data))
        : ((n.message = se(n.code)), (n.data = { originalError: de(t) }));
  } else
    (n.code = y.rpc.internal),
      (n.message = le(t, "message") ? t.message : _e),
      (n.data = { originalError: de(t) });
  return e && (n.stack = le(t, "stack") ? t.stack : void 0), n;
}
function xe(t) {
...
function dt(t, e = !1) {
  if (typeof t == "string") {
    ...
    if (Ne.test(n)) return q(e ? `0x${n}` : n);
  }
...
function P(t) {
  if (typeof t == "string") {
    const e = ae(t).toLowerCase();
    if (F(e) && e.length === 40) return ot(Oe(e));
  }
...
function U(t) {
  if (typeof t == "number" && Number.isInteger(t)) return _(t);
  if (typeof t == "string") {
    if (Te.test(t)) return _(Number(t));
    if (F(t)) return _(Number(BigInt(oe(t, !0))));
  }
...
function O(t) {
  ...
  if (typeof t == "number") return BigInt(U(t));
  if (typeof t == "string") {
    if (Te.test(t)) return BigInt(t);
    if (F(t)) return BigInt(oe(t, !0));
  }
  throw m.rpc.invalidParams(`Not an integer: ${String(t)}`);
}
function lt(t) {
...
const G = { storageKey: "ownPrivateKey", keyType: "private" },
  Y = { storageKey: "ownPublicKey", keyType: "public" },
  $ = { storageKey: "peerPublicKey", keyType: "public" };
class wt {
  constructor() {
    (this.storage = new A("CBWSDK", "SCWKeyManager")),
  ...
  async generateKeyPair() {
    ...
    (this.ownPrivateKey = e.privateKey),
      ...
      await this.storeKey(Y, e.publicKey);
  }
  async loadKeysIfNeeded() {
    if (
      (this.ownPrivateKey === null &&
        (this.ownPrivateKey = await this.loadKey(G)),
      this.ownPublicKey === null && (this.ownPublicKey = await this.loadKey(Y)),
      (this.ownPrivateKey === null || this.ownPublicKey === null) &&
        (await this.generateKeyPair()),
      this.peerPublicKey === null &&
        (this.peerPublicKey = await this.loadKey($)),
      this.sharedSecret === null)
    ) {
      if (this.ownPrivateKey === null || this.peerPublicKey === null) return;
      this.sharedSecret = await pt(this.ownPrivateKey, this.peerPublicKey);
    }
  }
  async loadKey(e) {
    const n = this.storage.getItem(e.storageKey);
    return n ? We(e.keyType, n) : null;
  }
  async storeKey(e, n) {
    const s = await Ue(e.keyType, n);
    this.storage.setItem(e.storageKey, s);
  }
}
const K = "4.2.3",
  qe = "@coinbase/wallet-sdk";
...
function kt({ metadata: t, preference: e }) {
  var n, s;
  ...
  if (e.options !== "smartWalletOnly") {
    ...
    if (l)
      return (
        (n = l.setAppInfo) === null || n === void 0 || n.call(l, r, i, a, e), l
      );
  }
  const c = vt();
  if (c != null && c.isCoinbaseBrowser)
    return (
      (s = c.setAppInfo) === null || s === void 0 || s.call(c, r, i, a, e), c
    );
}
function Et(t) {
  if (!t || typeof t != "object" || Array.isArray(t))
...
class It {
  constructor(e) {
    ...
    (this.metadata = e.metadata),
      ...
      (this.keyManager = new wt()),
      (this.storage = new A("CBWSDK", "SCWStateManager")),
      (this.accounts =
        (n = this.storage.loadObject(ue)) !== null && n !== void 0 ? n : []),
      (this.chain = this.storage.loadObject(he) || {
        id:
          (r =
  ...
  async handshake(e) {
    ...
    const a = await We("public", i.sender);
    await this.keyManager.setPeerPublicKey(a);
    const l = (await this.decryptResponseMessage(i)).result;
    if ("error" in l) throw l.error;
    const h = l.value;
    (this.accounts = h),
      this.storage.storeObject(ue, h),
      (s = this.callback) === null ||
        s === void 0 ||
        s.call(this, "accountsChanged", h);
  }
  async request(e) {
    var n;
    if (this.accounts.length === 0) throw m.provider.unauthorized();
    switch (e.method) {
      case "eth_requestAccounts":
        return (
          (n = this.callback) === null ||
            n === void 0 ||
            n.call(this, "connect", { chainId: L(this.chain.id) }),
          this.accounts
        );
      case "eth_accounts":
      ...
      case "wallet_getCapabilities":
        return this.storage.loadObject(fe);
  ...
  async sendEncryptedRequest(e) {
    ...
    const s = await mt({ action: e, chainId: this.chain.id }, n),
  ...
  async createRequestMessage(e) {
    const n = await Ue("public", await this.keyManager.getOwnPublicKey());
    return {
      id: crypto.randomUUID(),
      sender: n,
      content: e,
  ...
  async decryptResponseMessage(e) {
    ...
    if (!i) throw m.provider.unauthorized("Invalid session");
    const a = await bt(r.encrypted, i),
      c = (n = a.data) === null || n === void 0 ? void 0 : n.chains;
    if (c) {
      const h = Object.entries(c).map(([p, g]) => ({
        id: Number(p),
        rpcUrl: g,
      }));
    ...
    return l && this.storage.storeObject(fe, l), a;
  }
  updateChain(e, n) {
    var s;
    const r = n ?? this.storage.loadObject(pe),
      i = r == null ? void 0 : r.find((a) => a.id === e);
    return i
      ? (i !== this.chain &&
          ((this.chain = i),
          this.storage.storeObject(he, i),
          (s = this.callback) === null ||
            s === void 0 ||
            s.call(this, "chainChanged", L(i.id))),
        !0)
      : !1;
  }
}
...
function Be() {
  ...
  function s(o, u) {
    let b = o.toString(16);
    b.length % 2 !== 0 && (b = "0" + b);
    const f = b.match(/.{1,2}/g).map((v) => parseInt(v, 16));
    for (; f.length < u; ) f.unshift(0);
  ...
  function r(o, u) {
    ...
    let f;
    if (b) {
      const v = (1n << BigInt(u)) - 1n;
      f = (~o & v) + 1n;
    } else f = o;
    return (f &= (1n << BigInt(u)) - 1n), f;
  }
  function i(o, u, b) {
    const f = e(u);
    return (
  ...
  function c(o) {
    if (!Buffer.isBuffer(o))
      if (Array.isArray(o)) o = Buffer.from(o);
        ...
        g(o) ? (o = Buffer.from(p(d(o)), "hex")) : (o = Buffer.from(o));
...
function St() {
  ...
  function a(d, o) {
    ...
    if (l(d)) {
      ...
      for (v in o) f.push(a(d, o[v]));
      if (u === "dynamic") {
        var E = a("uint256", o.length);
        f.unshift(E);
      }
      ...
      if (d === "bytes")
        return (
          (o = new Buffer(o)),
          (f = Buffer.concat([a("uint256", o.length), o])),
          o.length % 32 !== 0 &&
            (f = Buffer.concat([f, t.zeros(32 - (o.length % 32))])),
          f
        );
      if (d.startsWith("bytes")) {
        ...
        b = i(o);
        const I = t.bitLengthFromBigInt(b);
        if (I > u)
          throw new Error("Supplied uint exceeds width: " + u + " vs " + I);
        if (b < 0) throw new Error("Supplied uint is negative");
        ...
        const I = t.bitLengthFromBigInt(b);
        if (I > u)
          throw new Error("Supplied int exceeds width: " + u + " vs " + I);
  ...
  function h(d, o) {
    ...
    for (var v in d) {
      var E = e(d[v]),
        I = o[v],
        C = a(E, I);
      c(E) ? (u.push(a("uint256", f)), b.push(C), (f += C.length)) : u.push(C);
    }
  ...
  function p(d, o) {
    ...
    for (var u, b, f = [], v = 0; v < d.length; v++) {
      var E = e(d[v]),
        I = o[v];
      if (E === "bytes") f.push(I);
      else if (E === "string") f.push(new Buffer(I, "utf8"));
      else if (E === "bool") f.push(new Buffer(I ? "01" : "00", "hex"));
      else if (E === "address") f.push(t.setLength(I, 20));
      else if (E.startsWith("bytes")) {
        if (((u = n(E)), u < 1 || u > 32))
          throw new Error("Invalid bytes<N> width: " + u);
        f.push(t.setLengthRight(I, u));
      } else if (E.startsWith("uint")) {
        if (((u = n(E)), u % 8 || u < 8 || u > 256))
          throw new Error("Invalid uint<N> width: " + u);
        b = i(I);
        const C = t.bitLengthFromBigInt(b);
        if (C > u)
          throw new Error("Supplied uint exceeds width: " + u + " vs " + C);
        f.push(t.bufferBEFromBigInt(b, u / 8));
        ...
        f.push(t.bufferBEFromBigInt(Ve, u / 8));
      } else throw new Error("Unsupported or invalid type: " + E);
    }
    return Buffer.concat(f);
  }
  function g(d, o) {
    return t.keccak(p(d, o));
  }
  return (V = { rawEncode: h, solidityPack: p, soliditySHA3: g }), V;
}
var Q, be;
function Ct() {
  if (be) return Q;
  ...
  const t = Be(),
    ...
    s = {
        ...
        if (l) {
          const g = (d, o, u) => {
            if (c[o] !== void 0)
              return [
                ...
                u == null
                  ...
                  : t.keccak(this.encodeData(o, u, c, l)),
              ];
            if (u === void 0)
              throw new Error(`missing value for field ${d} of type ${o}`);
            if (o === "bytes") return ["bytes32", t.keccak(u)];
            if (o === "string")
              return (
            ...
            if (o.lastIndexOf("]") === o.length - 1) {
              const b = o.slice(0, o.lastIndexOf("[")),
                f = u.map((v) => g(d, b, v));
              return [
                "bytes32",
                t.keccak(
          ...
          for (const d of c[i]) {
            const [o, u] = g(d.name, d.type, a[d.name]);
            h.push(o), p.push(u);
          }
        } else
          for (const g of c[i]) {
            ...
            if (d !== void 0)
              if (g.type === "bytes")
                h.push("bytes32"), (d = t.keccak(d)), p.push(d);
              else if (g.type === "string")
                h.push("bytes32"),
                  typeof d == "string" && (d = Buffer.from(d, "utf8")),
                  (d = t.keccak(d)),
                  p.push(d);
              else if (c[g.type] !== void 0)
                h.push("bytes32"),
                  (d = t.keccak(this.encodeData(g.type, d, c, l))),
                  p.push(d);
              else {
                ...
                h.push(g.type), p.push(d);
              }
          }
        return e.rawEncode(h, p);
      },
      encodeType(i, a) {
        let c = "",
          l = this.findTypeDependencies(i, a).filter((h) => h !== i);
        l = [i].concat(l.sort());
        for (const h of l) {
          if (!a[h]) throw new Error("No type definition specified: " + h);
          c +=
            h +
            "(" +
            a[h].map(({ name: g, type: d }) => d + " " + g).join(",") +
            ")";
        }
        return c;
      },
      ...
      sanitizeData(i) {
        const a = {};
        for (const c in n.properties) i[c] && (a[c] = i[c]);
        return (
          a.types && (a.types = Object.assign({ EIP712Domain: [] }, a.types)), a
        );
      },
      hash(i, a = !0) {
  ...
  function r(i) {
    ...
    const c = i.map(function (p) {
        return p.type === "bytes" ? t.toBuffer(p.value) : p.value;
      }),
      l = i.map(function (p) {
        return p.type;
      }),
...
class xt {
  ...
  async encrypt(e) {
    ...
    const s = crypto.getRandomValues(new Uint8Array(12)),
      r = await crypto.subtle.importKey("raw", z(n), { name: "aes-gcm" }, !1, [
        "encrypt",
        "decrypt",
      ]),
      i = new TextEncoder(),
    ...
    return new Promise((s, r) => {
      (async function () {
        const i = await crypto.subtle.importKey(
          ...
          g = { name: "AES-GCM", iv: new Uint8Array(c) };
        try {
          const d = await window.crypto.subtle.decrypt(g, i, p),
            o = new TextDecoder();
          s(o.decode(d));
        } catch (d) {
          r(d);
      ...
      (s = this.connectionStateListener) === null ||
        ...
        (r.onopen = (i) => {
          ...
          e(),
            (a = this.connectionStateListener) === null ||
              a === void 0 ||
              a.call(this, R.CONNECTED),
            this.pendingData.length > 0 &&
              ([...this.pendingData].forEach((l) => this.sendData(l)),
              (this.pendingData = []));
        }),
        (r.onmessage = (i) => {
          var a, c;
...
class Tt {
  ...
  heartbeat() {
    if (Date.now() - this.lastHeartbeatResponse > we * 2) {
      this.ws.disconnect();
      return;
    }
    try {
...
class D {
  ...
  save() {
    return (
      this.storage.setItem(ye, this.id),
      this.storage.setItem(ve, this.secret),
      this.persistLinked(),
      this
    );
  }
  persistLinked() {
    this.storage.setItem(ke, this._linked ? "1" : "0");
  }
}
function Dt() {
  try {
...
function Fe() {
  ...
  (t.type = "text/css"),
    t.appendChild(document.createTextNode(Ut)),
...
const Yt = ({
  ...
  $t = "https://keys.coinbase.com/connect",
  Ee = "https://www.walletlink.org",
  Jt = "https://go.cb-w.com/walletlink";
class Ie {
  constructor() {
  ...
  redirectToCoinbaseWallet(e) {
    const n = new URL(Jt);
    n.searchParams.append("redirect_url", Ot().href),
...
class x {
  constructor(e) {
      ...
      (this.accountUpdated = (i) => {
        this.accountsCallback && this.accountsCallback([i]),
          x.accountRequestCallbackIds.size > 0 &&
            (Array.from(x.accountRequestCallbackIds.values()).forEach((a) => {
    ...
    (this._session = n),
      (this.connection = r),
      (this.relayEventManager = new Nt()),
      (this.ui = s),
      this.ui.attach();
  }
  subscribe() {
    const e = D.load(this.storage) || D.create(this.storage),
      { linkAPIUrl: n } = this,
      s = new Tt({ session: e, linkAPIUrl: n, listener: this }),
      r = this.isMobileWeb ? new Ie() : new Ft();
  ...
  resetAndReload() {
    this.connection
      ...
      .then(() => {
        ...
        (e == null ? void 0 : e.id) === this._session.id && A.clearAll(),
  ...
  signEthereumTransaction(e) {
    return this.sendRequest({
      ...
      params: {
        ...
        weiValue: M(e.weiValue),
        data: j(e.data, !0),
        nonce: e.nonce,
        gasPriceInWei: e.gasPriceInWei ? M(e.gasPriceInWei) : null,
        maxFeePerGas: e.gasPriceInWei ? M(e.gasPriceInWei) : null,
        maxPriorityFeePerGas: e.gasPriceInWei ? M(e.gasPriceInWei) : null,
        gasLimit: e.gasLimit ? M(e.gasLimit) : null,
        chainId: e.chainId,
        shouldSubmit: !1,
      },
    });
  ...
  signAndSubmitEthereumTransaction(e) {
    return this.sendRequest({
      ...
      params: {
        ...
        nonce: e.nonce,
        gasPriceInWei: e.gasPriceInWei ? M(e.gasPriceInWei) : null,
        maxFeePerGas: e.maxFeePerGas ? M(e.maxFeePerGas) : null,
  ...
  submitEthereumTransaction(e, n) {
    return this.sendRequest({
      ...
      params: { signedTransaction: j(e, !0), chainId: n },
    });
  }
    ...
    return new Promise((i, a) => {
      (n = this.ui.showConnecting({
        ...
        this.relayEventManager.callbacks.set(s, (c) => {
          if ((n == null || n(), k(c))) return a(new Error(c.errorMessage));
          i(c);
        }),
  ...
  handleWeb3ResponseMessage(e, n) {
    if (n.method === "requestEthereumAccounts") {
      x.accountRequestCallbackIds.forEach((s) => this.invokeCallback(s, n)),
        x.accountRequestCallbackIds.clear();
      return;
    }
  ...
  requestEthereumAccounts() {
    ...
    return new Promise((i, a) => {
      this.relayEventManager.callbacks.set(r, (c) => {
        if (k(c)) return a(new Error(c.errorMessage));
        i(c);
      }),
        x.accountRequestCallbackIds.add(r),
    ...
    const h = T(8),
      p = (g) => {
        this.publishWeb3RequestCanceledEvent(h),
          this.handleErrorResponse(h, c.method, g),
          l == null || l();
      };
    return (
      ...
      new Promise((g, d) => {
        this.relayEventManager.callbacks.set(h, (o) => {
          if ((l == null || l(), k(o))) return d(new Error(o.errorMessage));
          g(o);
        }),
    ...
    return (
      ...
      new Promise((c, l) => {
        this.relayEventManager.callbacks.set(i, (h) => {
          ...
          if (k(h)) return l(new Error(h.errorMessage));
          c(h);
        }),
...
const Se = "DefaultChainId",
  Ce = "DefaultJsonRpcUrl";
class Ye {
  constructor(e) {
    (this._relay = null),
      (this._addresses = []),
      (this.metadata = e.metadata),
      (this._storage = new A("walletlink", Ee)),
  ...
  get jsonRpcUrl() {
    var e;
    return (e = this._storage.getItem(Ce)) !== null && e !== void 0
      ? e
      : void 0;
  }
  set jsonRpcUrl(e) {
    this._storage.setItem(Ce, e);
  }
  updateProviderInfo(e, n) {
    var s;
    this.jsonRpcUrl = e;
    const r = this.getChainId();
    this._storage.setItem(Se, n.toString(10)),
      U(n) !== r &&
        ((s = this.callback) === null ||
          s === void 0 ||
          s.call(this, "chainChanged", L(n)));
  }
  async watchAsset(e) {
    const n = Array.isArray(e) ? e[0] : e;
    if (!n.type) throw m.rpc.invalidParams("Type is required");
    ...
    const s = this.getChainId(),
      { address: r, symbol: i, image: a, decimals: c } = n.options,
      h = await this.initializeRelay().watchAsset(
        n.type,
        r,
        i,
        c,
  ...
  async addEthereumChain(e) {
    ...
    const a = this.initializeRelay(),
      ...
      d = await a.addEthereumChain(i.toString(), c, p, l, h, g);
    if (k(d)) return !1;
    if (
      ((s = d.result) === null || s === void 0 ? void 0 : s.isApproved) === !0
    )
  ...
  _setAddresses(e, n) {
    ...
    JSON.stringify(r) !== JSON.stringify(this._addresses) &&
      ...
      this._storage.setItem(ne, r.join(" ")));
  }
  async request(e) {
    const n = e.params || [];
    switch (e.method) {
      ...
      default:
        if (!this.jsonRpcUrl) throw m.rpc.internal("No RPC URL set for chain");
  ...
  _prepareTransactionParams(e) {
    ...
    const s = e.to ? P(e.to) : null,
      r = e.value != null ? O(e.value) : BigInt(0),
      i = e.data ? te(e.data) : Buffer.alloc(0),
      a = e.nonce != null ? U(e.nonce) : null,
      c = e.gasPrice != null ? O(e.gasPrice) : null,
      l = e.maxFeePerGas != null ? O(e.maxFeePerGas) : null,
      h = e.maxPriorityFeePerGas != null ? O(e.maxPriorityFeePerGas) : null,
      p = e.gas != null ? O(e.gas) : null,
      g = e.chainId ? U(e.chainId) : this.getChainId();
    return {
      fromAddress: n,
      toAddress: s,
      weiValue: r,
  ...
  async ecRecover(e) {
    ...
    if (!Array.isArray(s)) throw m.rpc.invalidParams();
  ...
  getChainId() {
    ...
    return Number.parseInt(
      (e = this._storage.getItem(Se)) !== null && e !== void 0 ? e : "1",
      10,
    );
  }
  async _eth_requestAccounts() {
    ...
    return (
      ...
      (n = this.callback) === null ||
        n === void 0 ||
        n.call(this, "connect", { chainId: L(this.getChainId()) }),
      this._addresses
    );
  }
  async personalSign({ params: e }) {
    if (!Array.isArray(e)) throw m.rpc.invalidParams();
    const n = e[1],
      s = e[0];
    this._ensureKnownAddress(n);
    const i = await this.initializeRelay().sendRequest({
...
const $e = "SignerType",
  Je = new A("CBWSDK", "SignerConfigurator");
function Vt() {
  return Je.getItem($e);
}
function Qt(t) {
...
function Xt(t) {
  ...
  switch (e) {
    case "scw":
      return new It({ metadata: n, callback: r, communicator: s });
    case "walletlink":
      return new Ye({ metadata: n, callback: r });
  }
}
async function en(t, e, n) {
  await t.onMessage(({ event: r }) => r === "WalletLinkSessionRequest");
  const s = new Ye({ metadata: e, callback: n });
  t.postMessage({
...
const tn = `Coinbase Wallet SDK requires the Cross-Origin-Opener-Policy header to not be set to 'same-origin'. This is to ensure that the SDK can communicate with the Coinbase Smart Wallet app.
...
Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`,
    ...
    return {
      ...
      checkCrossOriginOpenerPolicy: async () => {
        ...
        try {
          ...
          (t = s ?? "null"), t === "same-origin" && console.error(tn);
        } catch (e) {
          console.error(
  ...
  { checkCrossOriginOpenerPolicy: sn, getCrossOriginOpenerPolicy: rn } = nn(),
  Me = 420,
  Ae = 540;
function an(t) {
  const e = (window.innerWidth - Me) / 2 + window.screenX,
    n = (window.innerHeight - Ae) / 2 + window.screenY;
  cn(t);
  const s = window.open(
    t,
    "Smart Wallet",
    `width=${Me}, height=${Ae}, left=${e}, top=${n}`,
  );
  if ((s == null || s.focus(), !s))
      ...
      (this.onMessage = async (r) =>
        new Promise((i, a) => {
          ...
          window.addEventListener("message", c),
            this.listeners.set(c, { reject: a });
        })),
      (this.disconnect = () => {
        on(this.popup),
          (this.popup = null),
          this.listeners.forEach(({ reject: r }, i) => {
            r(m.provider.userRejectedRequest("Request rejected")),
        ...
        this.popup && !this.popup.closed
          ...
          : ((this.popup = an(this.url)),
            ...
            this.onMessage(({ event: r }) => r === "PopupLoaded")
              ...
              .then(() => {
                if (!this.popup) throw m.rpc.internal();
                return this.popup;
              }))),
      (this.url = new URL(e)),
      (this.metadata = n),
...
function ln(t) {
  const e = rt(un(t), { shouldIncludeStack: !0 }),
    n = new URL("https://docs.cloud.coinbase.com/wallet-sdk/docs/errors");
  return (
    n.searchParams.set("version", K),
...
class fn extends hn {
  constructor(e) {
    ...
    super(),
      ...
      (this.metadata = n),
      (this.preference = i),
      (this.communicator = new dn({ url: r, metadata: n, preference: i }));
    const a = Vt();
  ...
  async request(e) {
    try {
        ...
        switch (e.method) {
          case "eth_requestAccounts": {
            const n = await this.requestSignerSelection(e),
              s = this.initSigner(n);
            await s.handshake(e), (this.signer = s), Qt(n);
            break;
          }
          case "net_version":
            return 1;
      ...
      const { code: s } = n;
      return (
        s === y.provider.unauthorized && this.disconnect(),
        Promise.reject(ln(n))
      );
    }
  }
  ...
  async disconnect() {
    ...
    await ((e = this.signer) === null || e === void 0 ? void 0 : e.cleanup()),
      ...
      this.emit(
        "disconnect",
        m.provider.disconnected("User initiated disconnection"),
      );
  }
...
function mn(t) {
  ...
  return (e = kt(n)) !== null && e !== void 0 ? e : new fn(n);
}
const bn = { options: "all" };
function kn(t) {
  var e;
  new A("CBWSDK").setItem("VERSION", K), sn();
  const s = {
    metadata: {
  ...
  gn(s.preference);
  let r = null;
  return { getProvider: () => (r || (r = mn(s)), r) };
}
export { kn as createCoinbaseWalletSDK };
